...
class PurchaseOrderLine(models.Model):
    ...
    def _compute_product_packaging_qty(self):
        for line in self:
            ...
            line.product_packaging_qty = line.product_qty / factor if factor else 0.0
    ...
    def onchange_product_id(self):
        ...
        for line in self:
            ...
            # When buying by pack, start from one full pack instead of inheriting
            # a loose product quantity that makes subtotal drift from pack price.
    ...
    def _onchange_product_packaging_id(self):
        ...
        for line in self:
            if line.product_packaging_id:
                line._apply_purchase_packaging(
                    line.product_packaging_id,
                    line.product_packaging_qty or 1.0,
                )
